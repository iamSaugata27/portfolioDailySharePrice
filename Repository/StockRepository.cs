...
namespace DailySharePriceApi.Repository
{
    public class StockRepository : IStockRepository
    {
        ...
        {
            new Stock { StockId = 101, StockName = "TATA MOTORS", StockValue = 389.00},
            new Stock { StockId = 102, StockName = "ONGC", StockValue = 136.10},
            new Stock {StockId = 103, StockName = "POWERGRID", StockValue = 209.05}
        };
